...
public class MapDrawer {
    ...
    //Constructors
    public MapDrawer(String floorPlan) {
    }
    public MapDrawer(Cell startLocation) {
    }


    //TODO: draw path, etc. in fragment -> add param for spinner onSelectItem -> add fragment support
